...
function Badge({ className, variant = "default", ...props }: BadgeProps) {
  ...
  let variantClass = ""
  if (variant === "default") variantClass = "border-transparent bg-primary text-primary-foreground shadow hover:bg-primary/80"
  else if (variant === "secondary") variantClass = "border-transparent bg-secondary text-secondary-foreground hover:bg-secondary/80"
